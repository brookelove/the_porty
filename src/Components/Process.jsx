...
const Process = () => {
    ...
    useEffect(()=> {
        var processDivEl = document.querySelector(".processSteps");
        // console.log(processDivEl.children)
        var processChildArr = processDivEl.children;
        
        // for (let i = 0; i < processChildArr.length; i++){
        //     console.log(processChildArr[i].classList)
            // processChildArr[i].classList.remove("pink")
        ...
        //     }, 1000)
        //     console.log(timer)
        //     processChildArr[i].classList.add("pink")
        // }
